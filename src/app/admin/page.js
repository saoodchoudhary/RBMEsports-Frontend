...
import { BsPeopleFill, BsDiscord, BsBroadcast } from "react-icons/bs";
import { FaCrown, FaYoutube, FaPlay } from "react-icons/fa";
...
export default function HomePage() {
  ...
  const [pageError, setPageError] = useState(""); // ✅ NEW: show if api fails
  ...
  async function loadData() {
    ...
    try {
      // Priority: tournaments list
      const tournamentsRes = await api.listTournaments("?limit=12&page=1").catch((e) => {
        throw e;
      });

      // Optional: winners + featured (don’t block tournaments render)
      const winnersRes = await (api.winnersRecent?.(8) ?? Promise.resolve({ data: [] })).catch(() => ({ data: [] }));
      const featuredRes = await api.listTournaments("?featured=true&limit=3").catch(() => ({ data: [] }));
      ...
      setData({ tournaments: [], winners: [], featuredTournaments: [] });

      // ✅ helpful error
      setPageError(
        error?.message ||
          "Failed to load tournaments. Please check API base URL (NEXT_PUBLIC_API_BASE_URL) and backend."
      );
    } finally {
      setLoading(false);
    }
    ...
    <div className="w-full">
      <div className=" ">
        <div className="space-y-12 sm:space-y-16 lg:space-y-20">
          {/* ✅ Error Banner (only if tournaments fetch failed) */}
          {pageError ? (
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="rounded-2xl border border-red-200 bg-red-50 p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                  <div className="font-bold text-red-800">Could not load tournaments</div>
                  <div className="text-sm text-red-700 break-words">{pageError}</div>
                </div>
                <Button type="button" onClick={loadData} className="bg-red-600 hover:bg-red-700 text-white">
                  Retry
                </Button>
              </div>
            </div>
            ...
            <div className="relative z-10 px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
              <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                ...
                <div className="flex-1 w-full">
                  {/* YouTube Live Badge (✅ removed sample stats text) */}
                  ...
                  <p className="text-sm sm:text-base lg:text-lg text-gray-300 leading-relaxed mb-5 sm:mb-6 lg:mb-7 max-w-xl">
                    India's #1 BGMI Tournament Platform. Compete with elite players, win massive prizes, and get featured
                    live on our official YouTube channel.
                  </p>

                  {/* Live Stream Card (✅ removed sample watching count + dummy labels) */}
                  <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-5 border border-gray-700 shadow-xl mb-6 sm:mb-7 lg:mb-8 max-w-lg">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400">Official Stream</p>
                        </div>
                      </div>
                      <a
                    ...
                    <div className="flex items-center gap-3 mt-3 pt-3 border-t border-gray-700">
                      <span className="flex items-center gap-1 text-xs text-gray-400">
                        <FiEye className="w-3 h-3" /> Live Stream
                      </span>
                      <span className="flex items-center gap-1 text-xs text-gray-400">
                        <GiMicrophone className="w-3 h-3" /> Commentary
                      </span>
                    </div>
                  </div>
                      ...
                      <div className="absolute -bottom-4 -left-4 bg-gray-900/95 backdrop-blur-sm rounded-lg px-3 py-2 shadow-2xl border border-red-600/30">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] text-gray-400">Official Channel</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-400">Watch tournaments live on YouTube</p>
                  </div>
                </div>
                <a
                  href="https://youtube.com/@rbmesports"
          ...
          <section className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 lg:p-8 border border-gray-200 shadow-sm">
            <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10">
              <div className="flex-1 text-center lg:text-left">
                ...
                {/* ✅ Removed dummy schedule boxes (sample text) — keep section but minimal */}
                <a
                  href="https://youtube.com/@rbmesports"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <div className="relative h-40 sm:h-44 lg:h-48 w-full max-w-xs mx-auto">
                  ...
                  <div className="relative h-full w-full flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-gray-600 mt-0.5">Official Channel</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="space-y-6 sm:space-y-7 lg:space-y-8">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <p className="text-sm text-gray-600">Everything you need to compete at the highest level</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-600">Recent winners</p>
                </div>
              </div>
              <a
                href="/winners"
            ...
            <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10">
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-sm text-white/90 mb-5 max-w-lg mx-auto lg:mx-0">
                  Join our Discord server for tournament updates and community events.
                </p>
              ...
              <div className="flex-1">
                <div className="grid grid-cols-2 gap-3 sm:gap-4">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 text-center border border-white/20">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">RBM</div>
                    <div className="text-[10px] sm:text-xs text-blue-100">Community</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 text-center border border-white/20">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">BGMI</div>
                    <div className="text-[10px] sm:text-xs text-blue-100">Tournaments</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 text-center border border-white/20">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">LIVE</div>
                    <div className="text-[10px] sm:text-xs text-blue-100">Streams</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 sm:p-4 text-center border border-white/20">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-white">24/7</div>
                    <div className="text-[10px] sm:text-xs text-blue-100">Support</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl sm:rounded-2xl shadow-2xl">
            ...
            <div className="relative z-10 px-5 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12 text-center">
              ...
              <p className="text-sm text-gray-300 mb-5 max-w-2xl mx-auto px-4">
                Join thousands of players on India's most competitive BGMI platform.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 pt-5 border-t border-gray-700 max-w-2xl mx-auto">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs sm:text-sm font-bold text-gray-300">PRO</span>
                ...
                <div className="flex flex-col items-center">
                  <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-lg bg-gradient-to-br from-gray-700/50 to-gray-800/50 flex items-center justify-center mb-1 border border-gray-600">
                    <FiCheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-gray-300" />
                  </div>
                  <span className="text-xs sm:text-sm font-bold text-gray-300">FAIR</span>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs sm:text-sm font-bold text-gray-300">FAST</span>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs sm:text-sm font-bold text-gray-300">RBM</span>
                  <span className="text-[10px] text-gray-400">Esports</span>
                </div>
              </div>
            </div>
          </section>

          {/* ✅ Join modal (home page se open) */}
          <JoinTournamentModal
            open={joinOpen}
            onClose={() => {
              setJoinOpen(false);
