...
import { FaCrown, FaMedal, FaRegGem } from "react-icons/fa";
...
export default async function WinnersPage() {
  ...
  const totalWinners = (featuredWinners.length + recentWinners.length);
    ...
    <div className="space-y-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-slate-700 mt-1">Celebrating the legends of RBM ESports</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 text-center border border-amber-100">
                  <div className="text-2xl font-bold text-emerald-700">₹{(totalWinners * 5000).toLocaleString()}</div>
            ...
            <div className="md:w-auto">
              <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl p-4 text-white text-center shadow-lg">
                ...
                <div className="text-sm opacity-90">Top performers recognized</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-600">Top performers with exceptional achievements</p>
            </div>
          </div>
        ...
        {featuredWinners.length > 0 ? (
          ...
          <div className="bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-dashed border-amber-200 rounded-2xl p-12 text-center">
            ...
            <p className="text-slate-600 max-w-md mx-auto">
              Featured champions will appear here based on exceptional tournament performance
            </p>
          </div>
        )}
      </section>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-600">Latest tournament champions</p>
            </div>
          </div>
        ...
        {recentWinners.length > 0 ? (
          <>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {recentWinners.slice(0, 8).map((winner) => (
                <div key={winner._id} className="group">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-dashed border-blue-200 rounded-2xl p-12 text-center">
            ...
            <p className="text-slate-600 max-w-md mx-auto">
              Recent tournament winners will appear here. Check back after tournament completion.
            </p>
          </div>
        )}
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4">
            ...
            <p className="text-sm text-slate-600">
              Winners are featured permanently in our hall of fame
            </p>
          </div>
          ...
          <div className="text-center p-4">
            ...
            <p className="text-sm text-slate-600">
              Based on tournament performance and consistency
            </p>
          </div>
          ...
          <div className="text-center p-4">
            ...
            <p className="text-sm text-slate-600">
              Special privileges for featured champions
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="text-center space-y-6">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto">
          Every tournament victory adds to your legacy. Win consistently to earn 
          featured champion status and permanent recognition in the RBM ESports hall of fame.
        </p>
        
        <div className="pt-6 border-t border-slate-200">
          <div className="text-sm text-slate-500">
            Profiles updated after admin verification. All winners are permanently recorded.
          </div>
        </div>
      </section>
    </div>
