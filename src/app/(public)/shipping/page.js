...
import { FiHome, FiCheckCircle, FiMail, FiInfo, FiSmartphone } from "react-icons/fi";
...
export default function ShippingPage() {
  return (
    <LegalPage
      ...
      subtitle="Digital tournament services only — no physical shipping."
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-white border border-blue-200 rounded-lg p-6 text-center">
          ...
          <p className="text-gray-700 max-w-lg mx-auto">
            RBM ESports provides <strong className="text-gray-900">
            100% digital tournament services</strong>. 
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  UPI payment proof is verified manually by admin.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Tournament slot confirmed after verification.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 text-sm mb-1">
                  Room Details Delivery
                </p>
                <p className="text-xs text-gray-600">
                  Room ID & password shared before match via dashboard.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Access granted via user dashboard instantly.
                </p>
              </div>
            </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">
                All tournament services including participation access,
                room details, and match updates are delivered digitally
                through the RBM ESports platform. No shipping address is required.
              </p>
            </div>
          </div>
        </div>
