...
export default function HomePage() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        // Backend exists:
        // - GET /api/tournaments?limit=12&page=1
        // - GET /api/winners/recent?limit=8
        // - GET /api/tournaments?featured=true&limit=3
  ...
  // ✅ Backend-aligned "stats" (no /stats endpoint required)
  const computedStats = useMemo(() => {
    const tournaments = data.tournaments || [];
    const totalTournaments = tournaments.length;

    // Tournament schema has prizePool and currentParticipants
              ...
              <div className="flex-1 lg:py-12">
                ...
                <div className="flex flex-wrap gap-6 mb-8">
                  ...
                  <div className="flex items-center gap-3 bg-white/50 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-slate-100">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-slate-900">
                        ₹{computedStats.totalPrize.toLocaleString("en-IN")}
                      </div>
                      <div className="text-sm text-slate-600">Prize Pool (Total)</div>
                    </div>
                  </div>
            ...
            >
              <div
                className={`h-2 w-2 rounded-full ${
                  activeTab === "live" ? "bg-blue-500 animate-pulse" : "bg-slate-400"
                }`}
              ></div>
              Live Tournaments
            </button>
        ...
        <div className="relative z-10 p-8 md:p-12 lg:p-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-700 mb-8 max-w-2xl mx-auto">
              Join thousands of elite players on India's most competitive BGMI tournament platform.
              Prove your skills, claim your rewards, and etch your name in the halls of legendary champions.
            </p>
