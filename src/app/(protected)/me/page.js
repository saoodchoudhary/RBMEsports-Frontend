    ...
    <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-6">
          ...
          <div className="flex items-start gap-4">
            <div className="relative">
              <div className="h-20 w-20 rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-500 flex items-center justify-center shadow-lg overflow-hidden">
                {user?.profileImage ? (
                  // profileImage is available in backend Winner populate; for user profile it may or may not exist.
                  <img
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-2">
                <h1 className="text-2xl font-bold text-slate-900 truncate">{user?.name || "Player"}</h1>
          ...
          <div className="md:ml-auto flex flex-col sm:flex-row gap-3">
            ...
            {!profileComplete && (
              <Button
                className="bg-gradient-to-r from-amber-600 to-orange-500 hover:from-amber-700 hover:to-orange-600 flex items-center gap-2"
                onClick={() => (window.location.href = "/profile/edit")}
                type="button"
              >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="card p-4 text-center hover:shadow-lg transition-shadow">
          ...
          <div className="text-2xl font-bold text-slate-900">₹{stats.totalPrize.toLocaleString("en-IN")}</div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                >
                  {profileComplete ? <FiCheckCircle className="w-4 h-4" /> : <FiClock className="w-4 h-4" />}
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto pr-2">
              {tournaments.map((tournament, index) => {
                ...
                const getStatusIcon = () => {
                  switch (status) {
                    case "won":
                      return <GiTrophy className="w-4 h-4" />;
                    case "completed":
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex-shrink-0">
                        <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-gradient-to-r ${getStatusColor()} text-white text-xs font-semibold`}>
                          {getStatusIcon()}
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-xl bg-gradient-to-br from-slate-50 to-white border border-slate-200">
              ...
              <div className="text-2xl font-bold text-slate-900">{stats.bestRank ? `#${stats.bestRank}` : "-"}</div>
