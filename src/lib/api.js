...
export const api = {
  ...
  // ✅ my registration status (Protected)
  ...
  adminParticipants: (tournamentId) => request(`/admin/tournaments/${tournamentId}/participants`),
  ...
  adminManualPayments: (qs = "") => request(`/admin/manual-payments${qs}`),
  adminDecideManualPayment: (id, payload) =>
    request(`/admin/manual-payments/${id}/decision`, { method: "PUT", body: payload }),

  // Admin (payment reject/verify)
  adminRejectPayment: (paymentId, payload) =>
    request(`/admin/payments/${paymentId}/reject`, { method: "PUT", body: payload }),
  adminVerifyPayment: (paymentId) =>
    request(`/admin/payments/${paymentId}/verify`, { method: "PUT" })
};